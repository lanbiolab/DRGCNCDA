...
def read_triplets(filename):
    for line in open(filename, 'r+', encoding='ISO-8859-1'):
...
#print(read_triplets_as_list('data/FB15k/freebase_mtr100_mte100-train.txt', 'data/FB15k/entities_dict.txt', 'data/FB15k/relations_dict.txt'))
