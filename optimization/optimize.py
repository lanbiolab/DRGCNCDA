import sys
sys.path.append(r'C:\Users\zhy\Desktop\第三学期学习\code_R-GCN\optimization')
...
class Optimizer():
    ...
    def fit(self, training_data, validation_data=None):
        self.stack.set_training_data(training_data)# 将数据输入进栈
...
class TensorflowOptimizer(Optimizer):# function of optimizer
    ...
    def loss(self, placeholder_input):
        ...
        self.session.run([init_op, init_op_local])
